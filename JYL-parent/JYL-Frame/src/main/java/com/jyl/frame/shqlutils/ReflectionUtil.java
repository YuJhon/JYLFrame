...
/**
 * <p>功能描述</br> 提供调用getter/setter方法, 访问私有变量, 调用私有方法, 获取泛型类型Class, 被AOP过的真实类等工具函数.</p>
 * @className ReflectionUtil
 * @author jiangyu
 * @date 2016年3月17日 下午6:57:18
 * @version v1.0
 * @since v1.0
 */
...
public class ReflectionUtil
{
    ...
    /**
     * <p> 功能描述：调用Getter方法. 支持多级，如：对象名.对象名.方法</p>
     * @author jiangyu
     * @date 2016年3月17日 下午6:57:32
     * @param obj
     * @param propertyName
     * @return Object 处理结果的对象
     */
    ...
    /**
     * <p> 功能描述：调用Setter方法, 仅匹配方法名。</p>
     * @author jiangyu
     * @date 2016年3月17日 下午6:57:42
     * @param obj
    ...
    /**
     * <p> 功能描述：直接读取对象属性值, 无视private/protected修饰符, 不经过getter函数.</p>
     * @author jiangyu
     * @date 2016年3月17日 下午6:57:51
     * @param obj
     * @param fieldName
     * @return Object
     * @since v1.0
    ...
    /**
     * <p> 功能描述：直接设置对象属性值, 无视private/protected修饰符, 不经过setter函数.</p>
     * @author jiangyu
     * @date 2016年3月17日 下午6:58:04
     * @param obj
     * @param fieldName
     * @param value
     * @since v1.0
    ...
    /**
     * <p> 功能描述：直接调用对象方法,
     *               无视private/protected修饰符.用于一次性调用的情况，否则应使用getAccessibleMethod()函数获得Method后反复调用.</p>
     * @author jiangyu
     * @date 2016年3月17日 下午6:58:16
     * @param obj
     * @param methodName
    ...
    /**
     * <p>直接调用对象方法, 无视private/protected修饰符，用于一次性调用的情况，
     *               否则应使用getAccessibleMethodByName()函数获得Method后反复调用. 只匹配函数名，如果有多个同名函数调用第一个。</p>
     * @userName jiangyu
     * @date 2015年11月2日 下午4:33:59
     * @param obj
     * @param methodName
     * @param args
     * @return Object
