...
/**
 * <p>功能描述:</br> Excel 导出根据模板导出</p>
 * 
 * @className ExcelExportOfTemplateUtil
 * @author jiangyu
 * @date 2016年4月3日 下午5:22:41
 * @version v1.0
 */
public final class ExcelExportOfTemplateUtil
{
     ...
     * @date 2013-11-11
     */
    private static Workbook getCloneWorkBook(TemplateExportParams params)
        throws Exception
    {
        Workbook wb = null;
     ...
     * @param workbook
     */
    private static void addDataToSheet(TemplateExportParams params, Class<?> pojoClass, Collection<?> dataSet, Sheet sheet, Workbook workbook)
        throws Exception
    {
    ...
    private static String getValueDoWhile(Object object, String[] paramsArr, int index)
        throws Exception
    {
        if (object == null)
        {
     ...
     * @throws Exception
     */
    private static int createCells(Drawing patriarch, int index, Object t, List<ExcelExportEntity> excelParams, Sheet sheet, Workbook workbook)
        throws Exception
    {
     ...
     * @param styles
     */
    private static void createListCells(Drawing patriarch, int index, int cellNum, Object obj, List<ExcelExportEntity> excelParams, Sheet sheet, Workbook workbook)
        throws Exception
    {
        ExcelExportEntity entity;
        Row row;
     ...
     * @throws Exception
     */
    private static void createImageCell(Drawing patriarch, ExcelExportEntity entity, Row row, int i, String field, Object obj, Workbook workbook)
        throws Exception
    {
        ...
        row.createCell(i);
        ClientAnchor anchor = workbook instanceof HSSFWorkbook ? new HSSFClientAnchor(0, 0, 0, 0, (short)i, row.getRowNum(), (short)(i + 1), row.getRowNum() + 1) : new XSSFClientAnchor(0, 0, 0, 0,
            (short)i, row.getRowNum(), (short)(i + 1), row.getRowNum() + 1);
     ...
     * @throws Exception
     */
    private static void getExcelField(String targetId, Field field, ExcelExportEntity excelEntity, Excel excel, Class<?> pojoClass)
        throws Exception
    {
        excelEntity.setName(getExcelName(excel.exportName(), targetId));
