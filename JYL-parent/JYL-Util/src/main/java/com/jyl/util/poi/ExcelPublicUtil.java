...
import com.jyl.util.poi.annotation.ExcelEntity;
import com.jyl.util.poi.annotation.ExcelIgnore;
...
public class ExcelPublicUtil
{
    ...
    public static boolean isJavaClass(Field field)
    {
        ...
        else if (fieldType.isPrimitive() || fieldType.getPackage() == null || fieldType.getPackage().getName().equals("java.lang") || fieldType.getPackage().getName().equals("java.math")
